...
namespace Pulumi.Ct
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/cuemby/pulumi-ct/releases/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Ct.version.txt");
    ...
    internal sealed class CtResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public CtResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
