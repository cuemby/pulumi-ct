...
import (
	...
	"github.com/cuemby/pulumi-ct/provider/pkg/version"
...
func Provider() tfbridge.ProviderInfo {
	...
	p := shimv2.NewProvider(ct.Provider())
	...
	prov := tfbridge.ProviderInfo{
		...
		Keywords:   []string{"cuemby", "ct", "category/cloud"},
		License:    "Apache-2.0",
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"ct_config": {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "ctConfig")},
		},
